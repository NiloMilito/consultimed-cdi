...
public class Constantes {
	...
	public static final String ADD_PACIENTE = "/admin/pages/pacientes/add_paciente.jsp";
	
	public static final String EXAMES = "/admin/pages/exames/list_exames.jsp";
	public static final String ADD_EXAMES = "/admin/pages/exames/add_exame.jsp";
	
	public static final String CONSULTAS = "/admin/pages/consultas/list_consultas.jsp";
	public static final String ADD_CONSULTAS = "/admin/pages/consultas/add_consulta.jsp";
